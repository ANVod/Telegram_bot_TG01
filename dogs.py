...
async def start(message: Message):
    await message.answer("Привет! Какая собака тебя интересует? \n"
                         "Напиши мне название породы собаки,\n"
...
async def send_dog_info(message: Message):
    ...
    if breed_info:
        ...
        if dog_image_url:
            ...
            await message.answer_photo(photo=dog_image_url, caption=translated_info)
        else:
